...
namespace SUO.BusinessObjects.FichaPaciente
{
    public class GetFichaPacienteResponse
    {        
        public GetFichaPacienteResponse(int id, string rutPaciente, string nombresPaciente, string apellidoPaterno, string apellidoMaterno, string direccionPaciente, string comunaPaciente,
